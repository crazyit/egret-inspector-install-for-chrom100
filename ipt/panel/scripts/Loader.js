...
(function (e) {
    ...
    (function (e) {
        var t = function () {
            function e() {}e.after = function (t, n, r) {
                if (e.funcs[n]) 
                    return;
...
Object.defineProperty(Object.prototype, "getDisplayName", {
    value: function () {
        ...
        if (egret.getQualifiedClassName) 
    ...
    (function (e) {
        var t = function (e) {
            ...
            t.getValue = function (e, t) {
                ...
                t.type = n;
                switch (n) {
                    case "string": r = JSON.stringify(e);
                        break;
                    case "number":
                        if (e == NaN) 
                            e = "NaN";
                        ...
                        r = e;
                        return r;
                    case "array": r = String(e);
                        t.expandable = true;
                        break;
                    case "object": r = e.constructor["name"] || e["__class__"] || "object";
                        t.expandable = true;
                        break;
                    case "function": r = String(e);
                        t.name;
                        break;
                    default: r = String(e)
                }
            ...
            t.parseRawProps = function (e, n, r, i) {
                ...
                for (var s in e) {
                    ...
                    if (typeof h == "function" && i.showMethods != true) 
                        continue;
            ...
            t.linkToIt = function (e, n) {
                ...
                if (n) {
                    for (var o = 0; o < r._children.length; o++) {
                        if (r._children[o].rawHash == n.rawHash) 
                            r._children[o] = n
            ...
            t.parseNode = function (e, n, r, i) {
                ...
                if (e.parent) 
                    n.parentHash = e.parent.hashCode;
            ...
            t.clone = function (e, n, r) {
                ...
                i.forEach(function (t) {
                    if (t == "events" || t == "_children" || t == "_props") 
                        return;
                ...
                if (e._children.length > 0) 
                    r._children = e._children.map(function (e) {
    ...
    (function (e) {
        var t = function () {
            ...
            e.prototype.on = function (e, t) {
                if (!this.namedCallbacks[e]) 
                    this.namedCallbacks[e] = [];
...
(function (e) {
    ...
    (function (t) {
        var n = function () {
            function t() {}t.prototype.getStagePortClass = function () {
        ...
        var t = function (t) {
            ...
            Object.defineProperty(n.prototype, "highlightHover", {
                set: function (e) {
                    ...
                    if (e != this.chkHighlightHover.is("checked")) 
                        this.chkHighlightHover.attr("checked", e);
                    
                    window.localStorage.setItem("highlightHover", String(e));
                    this.port.post({name: "highlightHover", data: e})
                },
                enumerable: true,
                configurable: true
            });
            Object.defineProperty(n.prototype, "highlightClick", {
                set: function (e) {
                    ...
                    if (e != this.chkHighlightClick.is(":checked")) 
                        this.chkHighlightClick.attr("checked", e);
                    
                    window.localStorage.setItem("highlightClick", String(e));
                    this.port.post({name: "highlightClick", data: e})
                },
                enumerable: true,
                configurable: true
            });
            Object.defineProperty(n.prototype, "preventTouch", {
                set: function (e) {
                    ...
                    if (e != this.chkPreventTouch.is(":checked")) 
                        this.chkPreventTouch.attr("checked", e);
                    
                    window.localStorage.setItem("preventTouch", String(e));
                    this.port.post({name: "preventTouch", data: this._preventTouch})
                },
                enumerable: true,
                configurable: true
            });
            n.prototype.init = function () {
                ...
                $.contextMenu({
                    ...
                    callback: function (t, n) {
                        ...
                        e.port.post({name: "store", hashCode: i})
                    }
                })
            };
            ...
            n.prototype.bindNode = function (t, n) {
                var r = this;
                t.removeAllEvents();
                if (t.memberName == "$LarkMetricMask") 
                    return;
...
console.log('bindNode t', t, "o:", o);
                ...
                h.click(function (e) {
                    var n = h.is(":checked");
                    t.visible = n;
                    console.log("h.click n:",n,"t.visible:",t);
            ...
            n.prototype.showGameSelection = function (t, n) {
                console.log("showGameSelection t:",t,"n:",n);
            ...
            n.prototype.showItInGame = function (e, t) {
                ...
                if (! t || t && this._highlightHover) 
                    this.transTreeSelection(e.rawHash, t)
            ...
            n.prototype.transTreeSelection = function (e, t) {
                ...
                this.mainPanel.port.post({name: "showTreeSelection", data: e, isHover: t})
            };
        ...
        var n = function (e) {
            ...
            function n() {
                ...
                this.refresh = function () {
                    t.port.post({name: "refreshProp", hash: t.selectedHash})
                };
                this.lastQuery = "";
            ...
            Object.defineProperty(n.prototype, "showMethods", {
                set: function (e) {
                    this._showMethods = e;
                    if (e != this.chkShowMethods.is(":checked")) 
                        this.chkShowMethods.attr("checked", e);
                    
                    window.localStorage.setItem("showMethods", String(e));
                    this.port.post({name: "showMethodsChanged", showMethods: this._showMethods, hash: this.selectedHash})
                },
                enumerable: true,
                configurable: true
            });
            Object.defineProperty(n.prototype, "showPrivate", {
                set: function (e) {
                    this._showPrivate = e;
                    if (e != this.chkShowPrivate.is(":checked")) 
                        this.chkShowPrivate.attr("checked", e);
                    
                    window.localStorage.setItem("showPrivate", String(e));
                    this.port.post({name: "showPrivateChanged", showPrivate: this._showPrivate, hash: this.selectedHash})
                },
                enumerable: true,
                configurable: true
            });
            n.prototype.init = function () {
                ...
                $.contextMenu({
                    ...
                    callback: function (e, n) {
                        ...
                        t.port.post({name: "store", hashCode: i, expression: r.data("expression")})
                    }
                })
            };
            ...
            n.prototype._initPropElement = function (e) {
                ...
                var n = $(t);
                if (e.isGetter && e.isSetter == false) 
                    n.addClass("noSetter");
            ...
            n.prototype._initValueActions = function (e, t, n) {
                ...
                i.data("expression", n);
                i.dblclick(function () {
                    if (e.expandable || e.isGetter && e.isSetter == false) 
                        return;
    ...
    (function (e) {
        var t = function (t) {
            ...
            n.prototype.showGameSelection = function (e, t, n) {
                console.log("showGameSelection e:",e,"t:",t,"n:",n);
...
function showChanges() {
    var e = "2.5.4";
    if (window.localStorage.getItem("showChange" + e)) 
        return;
