  ...
  (function (t) {
    var e = (function (t) {
      ...
      e.prototype._connect = function (t) {
        ...
        r.onDisconnect.addListener(function (disconnectedPort) {
            console.log('r Port disconnected', chrome.runtime.lastError);
    ...
    var r = (function (t) {
      ...
      e.prototype._connect = function (t) {
        ...
        r.onDisconnect.addListener(function (disconnectedPort) {
            console.log('e Port disconnected', chrome.runtime.lastError);
            if (disconnectedPort.error) {
                console.log('Disconnect reason:', disconnectedPort.error.message);
            } else {
                console.log('Port disconnected without specific reason');
  ...
  (function (e) {
    ...
    var i = (function (t) {
      ...
      e.prototype.detach = function () {
        ...
        console.log('监听 222222222222222222222222 e.prototype.detach');
        this.stage.removeListener(
    ...
    var o = (function (t) {
      ...
      console.log('lark.startTick(this.update, this);');

        lark.startTick(this.update, this);
      };
      e.prototype.stop = function () {
      console.log('lark.stopTick(this.update, this);');
...
(function (t) {
  ...
  (function (e) {
    ...
    var i = (function (i) {
      ...
      console.log('Egret2xInspector attach');
      ...
      s.prototype.removeListeners = function () {
        ...
        console.log('监听移除 3333333333333333333 ');
        this.stage.removeEventListener(
          t.Event.ENTER_FRAME,
          this.enterFrameHandler,
          this,
...
(function (egret) {
  ...
  (function (devtool) {
    ...
    function start() {
      ...
      var s = i();
      console.log('n || s',n,":::",s);
      console.log(`window[' lark_stages '] && lark_stages.length`, window[' lark_stages ']);
      if (n || s) {
        console.log('egret.devtool.Inspector.instance:', egret.devtool.Inspector.instance);
